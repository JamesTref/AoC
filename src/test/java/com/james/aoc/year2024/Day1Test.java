...
class Day1Test {
	...
	@Test
	void test() {
		String filePath = "src/test/resources/Day1_2024/test.txt";
	...
	@Test
	void findAnswer() {
		String filePath = "src/test/resources/Day1_2024/data.txt";
		Integer result = Day1.getAnswer(filePath, false);
	...
	@Test
	void test2() {
		String filePath = "src/test/resources/Day1_2024/test2.txt";
	...
	@Test
	void findAnswer2() {
		String filePath = "src/test/resources/Day1_2024/data2.txt";
		Integer result = Day1.getAnswer(filePath, true);
